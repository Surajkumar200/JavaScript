...
const Suarj = new Person("Suarj", "shaw", "JavaScript");
console.log(Suarj);
console.log(Suarj.__proto__);
console.log(Suarj.__proto__.__proto__);
console.log(Suarj.__proto__.__proto__.__proto__);
